...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_line_list = 10,                 /* line_list  */
...
static const char *const yytname[] =
{
  ...
  "DIV", "CR", "NUM", "$accept", "line_list", "line", "expression", "term",
  "single", YY_NULLPTR
};
...
{
       7,     9,    10,    14,    15,    11,    12,    13,     1,    16,
      17,     1,     8
};

static const yytype_int8 yycheck[] =
{
       0,     3,     4,     9,    10,     7,     5,     6,     8,    12,
      13,     8,     2
};
...
#line 1142 "y.tab.c"
  ...
  case 9: /* term: term MUL single  */
#line 29 "calc.y"
                                                                {(yyval.inum)=(yyvsp[-2].inum)*(yyvsp[0].inum);}
#line 1148 "y.tab.c"
    break;

  case 10: /* term: term DIV single  */
#line 30 "calc.y"
                                                                {(yyval.inum)=(yyvsp[-2].inum)/(yyvsp[0].inum);}
#line 1154 "y.tab.c"
    break;
